...
import { getEmployee, addEmployee, editEmployee, deleteEmployee } from 'Redux/employeeRedux/action';
        ...
        return (
            <div className="App">
                ...
                <header className="App-header">
                    <h1 className="App-title">Redux Chay</h1>
                </header>
...
export default connect(mapStateToProps, { getEmployee, addEmployee, editEmployee, deleteEmployee })(EmployeeApp);