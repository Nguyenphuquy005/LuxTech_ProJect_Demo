...
pygame.init()
m = 80
Imgbody = pygame.transform.scale(pygame.image.load('img/concho2.jpg'), (m, m))
Imgbhead = pygame.transform.scale(pygame.image.load('img/tao.jpg'), (m, m))
Imgfood = pygame.transform.scale(pygame.image.load('img/gamecho.png'), (m, m))

gameSurFace = pygame.display.set_mode((1500, 800))
pygame.display.set_caption('Game chó̉')
# mau sac
